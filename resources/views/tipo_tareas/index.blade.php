            ...
            <tbody>
                ...
                <tr id="{{$tipo_tarea->id}}">
                    ...
                    <td>
                        ...
                        @else
                        <button data-toggle="tooltip" data-placement="bottom" data-html="true" title="Existen tareas asociadas a este tipo" class="btn btn-danger" disabled="true"><i class="fas fa-trash-alt"></i></button>
                        @endif
                    </td>                   
                </tr>
                @endforeach
