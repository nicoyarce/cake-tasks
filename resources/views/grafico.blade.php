...
<div class="row" id="graficoBotones">
    <div class="col-6">
        ...
        <div class="col-12">
            ...
            <p class="m-0 text-center text-primary font-weight-bold" style="font-size:15px"><span
                    id="promedio_avances_tareas">{{ $promedio_avances_tareas }}</span>%</p>
        </div>
    </div>
    ...
    <div id="botones" class="col-6">
        <div class="row text-center">
            ...
            <div class="col-4">
                ...
                <p class="m-0 text-center text-primary font-weight-bold" style="font-size:15px">{{ $proyecto->avance }}%
                </p>
            </div>
            <div class="col-4">
                <p class="m-0 text-center font-weight-bold" style="font-size:15px">AVANCE PROYECTADO</p>
                <p class="m-0 text-center text-primary font-weight-bold" style="font-size:15px">
                    {{ $proyecto->porcentajeAtraso }}%</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="w-50">
                <h3 class="text-center"><span id="critica" class="badge badge-pill badge-warning"
                        style="display: none;">Crítica</span></h3>
            </div>
            <div class="w-50">
                <h3 class="text-center"><span id="trabajo_interno" class="badge badge-pill badge-info"
                        style="display: none;">Trabajo Propio</span></h3>
                <h3 class="text-center"><span id="trabajo_externo" class="badge badge-pill badge-primary"
                        style="display: none;">Trabajo Externo</span></h3>
            </div>
        </div>
        <div class="row">
            <ul class="detallesTarea list-group w-100 mb-1" style="display: none;">
                <li class="list-group-item"><span class="titulospan">Nombre tarea:</span><span
                        id="nombre"><br></span></li>
        ...
        <div class="row">
            <ul class="detallesTarea list-group w-50" style="display: none;">
                <li class="list-group-item"><span class="titulospan">Área:</span><br><span id="area"></span>
                </li>
                <li class="list-group-item"><span class="titulospan">Fecha Inicio Tarea:</span><span
                        id="fir"></span></li>
                <li class="list-group-item"><span class="titulospan">Fecha Término Tarea original:</span><span
                        id="ftro"></span></li>
                <li class="list-group-item"><span class="titulospan">Fecha Término Tarea modificada:</span><span
                        id="ftrm"></span></li>
                <li class="list-group-item"><span class="titulospan">Atraso [días]:</span><span
                        id="atraso"></span></li>
            </ul>
            <ul class="detallesTarea list-group w-50 mb-1" style="display: none;">
                <li class="list-group-item">
                    <p class="titulospan">Observaciones:</p>
                </li>
    ...
    $(document).ready(function() {
        ...
        $("#maximizar").on('click', function() {
            if ($("#main").hasClass("container")) {
                ...
                $("#barra").hide();
                $("#icono_maximizar").removeClass('fa-expand-arrows-alt').addClass(
                    'fa-compress-arrows-alt');
            } else {
                $("#main").removeClass("container-fluid").addClass("container");
                $("#barra").show();
                $("#icono_maximizar").removeClass('fa-compress-arrows-alt').addClass(
