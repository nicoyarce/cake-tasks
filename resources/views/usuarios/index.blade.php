...
<form method="POST">
    ...
    <div class="row justify-content-between">
        ...
        <div class="col-2 mb-2">
            <button formaction="{{ route('users.destroySelected') }}" id="borraSelec" type="submit" disabled
                class="btn btn-danger float-right"
                onclick="return confirm('¿Desea eliminar los usuarios seleccionados?')">Eliminar marcados
            ...
            <tbody>
                @foreach ($usuarios as $usuario)
                    <tr id="{{ $usuario->id }}">
                        ...
                        <td>
                            <a href="{{ action('UsersController@edit', $usuario['id']) }}" type="button"
                        ...
                        @if (Auth::user()->id != $usuario->id)
                            <td>
                                <button formaction="{{ route('users.destroy', $usuario->id) }}" type="submit"
                                    class="btn btn-danger" onclick="return confirm('¿Desea eliminar el usuario?')"><i
                        ...
                        @else
                            <td>
                                <span data-toggle="tooltip" data-placement="bottom" data-html="true"
                                    ...
                                    <button class="btn btn-danger" disabled="true" style="pointer-events: none;"><i
                                            class="fas fa-trash-alt"></i></button>
                                </span>
                            </td>
                            <td>
