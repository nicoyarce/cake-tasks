    ...
    <thead>
        <tr>
            ...
            @if (!is_null($proyecto->deleted_at))
                <th><a type="button" class="btn btn-primary float-right" href="/proyectosArchivados" title="">Atrás
                        <i class="fas fa-arrow-left "></i></a></th>
            @else
                <th><a type="button" class="btn btn-primary float-right" href="/proyectos" title="">Atrás <i
                            class="fas fa-arrow-left "></i></a></th>
            @endif
        </tr>
    </thead>
    <tbody>
...
<br>
@include('tareas.index', ['proyecto' => $proyecto, 'propiedades' => session('propiedades_grafico_cache')])
@endsection
