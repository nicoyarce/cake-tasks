                ...
                if ($row->filter()->isNotEmpty()) {
                    if ($key == 0) {
                        $proyecto = Proyecto::create([
                            'nombre' => $nombre,
                            'fecha_inicio' => Carbon::createFromFormat($formato, $fecha_inicio, $timeZone)->toDateTimeString(),
                            'fecha_termino_original' =>  Carbon::createFromFormat($formato, $fecha_termino, $timeZone)->toDateTimeString(),
                            'fecha_termino' =>  Carbon::createFromFormat($formato, $fecha_termino, $timeZone)->toDateTimeString()
                        ]);
                        $proyecto->save();
                    } else {
                        if ($indicador == "*") {
                            ...
                            $tarea->fecha_inicio = Carbon::createFromFormat($formato, $fecha_inicio, $timeZone)->toDateTimeString();
                            $tarea->fecha_termino_original =  Carbon::createFromFormat($formato, $fecha_termino, $timeZone)->toDateTimeString();
                            $tarea->fecha_termino =  Carbon::createFromFormat($formato, $fecha_termino, $timeZone)->toDateTimeString();
                            ...
                            $tareaHija->fecha_inicio = Carbon::createFromFormat($formato, $fecha_inicio, $timeZone)->toDateTimeString();
                            $tareaHija->fecha_termino = Carbon::createFromFormat($formato, $fecha_termino, $timeZone)->toDateTimeString();
                            if (is_numeric($nivel)) {
